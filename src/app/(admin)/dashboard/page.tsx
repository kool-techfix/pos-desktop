    ...
    <div className="dashboard-page">
      ...
      <div className="dashboard-page__columns">
        <section className="panel dashboard-page__sales">
          <div className="dashboard-page__section-header">
            ...
            <Link href="/sales" data-testid="link-dashboard-sales">
              ...
              <tbody>
                {sales.slice(0, 5).map((sale) => (
                  <tr key={sale.id}>
                    ...
                    <td className="muted">{dateTime(sale.createdAt)}</td>
                    <td className="total">{money(sale.total)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="panel dashboard-page__stock">
          ...
          <div className="dashboard-page__stock-list">
            {low.length ? (
              low.map((product) => (
                <div key={product.id} className="dashboard-page__stock-row">
                  <div>
                    <p>{product.name}</p>
          ...
          <div className="dashboard-page__section-footer">
            <Link href="/inventory" data-testid="link-dashboard-inventory">
      ...
      <div className="panel dashboard-page__data-note">
        ...
        <div>
          ...
          <span>
            Bluebird POS saves changes on this device, ready for the next shift.
          </span>
        </div>
        <Link href="/settings" data-testid="link-dashboard-settings">
